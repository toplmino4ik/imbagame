...
RESET.pp = {
    ...
    req: ()=>player.level>=25,
    reqDesc: ()=>`Reach Level 25 to Prestige.`,
    ...
    ctn: [
        {
            ...
            desc: `Increase grass gain by <b class="green">+300%</b> per level. This effect is increased by <b class="green">50%</b> for every <b class="yellow">25</b> levels.`,
        
            res: "pp",
            icon: ["Curr/Grass"],
                        
            cost: i => Decimal.pow(1.005,scale(E(i),1e6,2,0)).mul(1).ceil(),
