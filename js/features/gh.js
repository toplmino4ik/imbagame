MAIN.gh = {
    ...
    milestone: [
        {
            r: 1,
            desc: `Gain <b class="green">5x</b> more grass. Grass gain is increased by <b class="green">50000%</b> every grasshop. Unlock more automation upgrades.`,
...
RESET.gh = {
    ...
    req: ()=>player.level>=201,
    reqDesc: ()=>`Reach Level 201.`,
