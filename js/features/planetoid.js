    ...
    ctn: [
        {
            ...
            cost: i => Decimal.pow(1.000002,i).mul(1000).ceil(),
            ...
            desc: `Increase Planetarium gain by <b class="green">10</b> per level.<br>This effect is <b class="green">doubled</b> every <b class="yellow">25</b> levels.`,
            ...
            effect(i) {
                let x = Decimal.pow(100,i.div(25).floor()).mul(i.add(1))
